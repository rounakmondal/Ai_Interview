  ...
  return (
    <footer className="relative py-4 sm:py-6 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div 
  className="rounded-3xl p-4 sm:p-6 lg:p-8 shadow-2xl shadow-orange-500/20 border border-white/10"
...
>
  ...
  <Link to="/setup">
    <Button 
      className="bg-white hover:bg-neutral-100 font-bold px-8 py-2.5 rounded-full shadow-lg hover:shadow-xl transition-all border-0"
    >
