  ...
  return (
    <section id="govt-practice" className="py-20 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[400px] bg-orange-500/5 rounded-full blur-3xl" />
      </div>
      ...
      <div className="container px-4 max-w-6xl mx-auto relative">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <Card className="p-8 border-orange-500/20 bg-gradient-to-br from-orange-500/10 via-background to-background space-y-6">
              ...
              <Link to="/govt-practice">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full mt-4 py-3 px-6 rounded-xl bg-gradient-to-r from-orange-500 to-red-600 text-white font-semibold text-sm flex items-center justify-center gap-2 shadow-lg shadow-orange-500/20 hover:shadow-orange-500/30 transition-shadow"
                >
                  Start Preparing
          ...
          >
            {features.map((f, i) => (
              ...
              >
                <Card className="p-4 hover:border-orange-500/30 hover:bg-orange-500/5 transition-colors cursor-default space-y-2 border-border/40">
                  <div className="w-8 h-8 rounded-lg bg-orange-500/10 flex items-center justify-center">
                    <f.icon className="w-4 h-4 text-orange-600 dark:text-orange-400" />
                  </div>
                  <div>
