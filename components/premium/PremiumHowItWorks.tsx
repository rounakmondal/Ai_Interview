...
>
            <span className="w-1.5 h-1.5 rounded-full bg-orange-500 animate-pulse shadow-[0_0_8px_rgba(255,115,0,0.7)]" />
How It Works
          </motion.span>
...
<div className="absolute -bottom-20 -right-20 w-64 h-64 bg-red-500/20 rounded-full blur-3xl pointer-events-none" />
...
>
  <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-orange-500 to-red-600" />
  <div className="absolute inset-0 bg-gradient-to-r from-orange-300 via-orange-400 to-red-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
