          ...
          >
            ...
            <div className="bg-gradient-to-br from-violet-500/8 via-background to-background p-8 sm:p-10 flex flex-col justify-between gap-8">
              <div className="space-y-5">
                ...
                <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-orange-500 to-red-600 flex items-center justify-center text-white shadow-lg shadow-orange-500/25">
              ...
              <Link to="/chatbot">
                <motion.div
                  ...
                  whileTap={{ scale: 0.98 }}
                 className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-orange-500 to-red-600 text-white font-semibold text-sm shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 transition-shadow cursor-pointer"
                >
                  Open AI Chat
