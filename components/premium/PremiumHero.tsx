...
export default function PremiumHero() {
  ...
  style={{ 
    // বর্ডারকে গ্রেডিয়েন্ট লুক দিতে চাইলে নিচের স্টাইলটি কাজ করবে
    borderTop: '2px solid',
    borderImageSource: 'linear-gradient(90deg, orange, red)',
    borderImageSlice: 1,
    background: 'rgba(255, 255, 255, 0.02)' // হালকা ব্যাকগ্রাউন্ড যাতে টেক্সট ক্লিয়ার থাকে
  }}
>
    ...
    <div className="flex flex-wrap justify-center sm:justify-start items-center gap-x-6 gap-y-2">
      {trustedBy.map((co, i) => (
        <span 
          ...
          // এখানে কোম্পানির নামগুলোকেও গ্রেডিয়েন্ট কালার দেওয়া হয়েছে
          style={{
