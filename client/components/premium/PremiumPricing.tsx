...
const plans = [
  ...
  },
  {
    ...
    btnClass: "bg-gradient-to-r from-indigo-500 to-violet-600 hover:from-indigo-600 hover:to-violet-700 text-white border-0",
    features: [
  ...
  },
  {
    ...
    btnVariant: "outline" as const,
    btnClass: "border-violet-500/50 hover:border-violet-500",
    features: [
      "Everything in Pro",
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {plans.map((plan, idx) => (
            <motion.div
              ...
              className={`relative bg-card border-2 ${plan.color} rounded-2xl p-6 lg:p-8 flex flex-col gap-6 ${plan.name === "Pro" ? "shadow-xl shadow-indigo-500/10 lg:scale-105 lg:z-10" : ""}`}
            >
              {/* Badge */}
              {plan.badge && (
                <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                  <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-semibold text-white bg-gradient-to-r from-indigo-500 to-violet-600 shadow-md shadow-indigo-500/30 whitespace-nowrap">
              ...
              <div className="space-y-3 pt-2 border-t border-border/40">
                {plan.features.map((feature, fIdx) => (
                  <div key={fIdx} className="flex items-start gap-2.5">
                    <div className={`w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 ${plan.name === "Pro" ? "bg-indigo-500/15" : "bg-muted"}`}>
                      <Check className={`w-3 h-3 ${plan.name === "Pro" ? "text-indigo-500" : "text-foreground/60"}`} />
                    </div>
