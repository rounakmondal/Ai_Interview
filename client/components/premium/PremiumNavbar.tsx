  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`max-w-6xl mx-auto rounded-full px-4 sm:px-6 lg:px-8 transition-all duration-300 ${
            isDark
        ...
        >
          <div className="h-14 sm:h-16 flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center gap-2.5 flex-shrink-0">
              ...
              <span
                className={`font-semibold text-[15px] hidden sm:inline tracking-tight transition-colors duration-300 ${
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <motion.a
                ...
                className={`text-[14px] font-medium transition-colors duration-200 px-3 py-2 ${
                  isDark ? "text-white/60 hover:text-white/90" : "text-slate-500 hover:text-slate-900"
                }`}
              >
                Sign In
              </motion.a>
          ...
          <>
            ...
            <motion.div
              ...
              className={`fixed inset-0 backdrop-blur-sm z-40 md:hidden ${
                isDark ? "bg-slate-900/60" : "bg-slate-600/30"
              }`}
            />
            ...
            <motion.div
              ...
              className={`fixed top-24 left-4 right-4 backdrop-blur-xl border rounded-2xl z-50 md:hidden shadow-2xl overflow-hidden ${
                isDark
            ...
            >
              <div className="p-4 space-y-1">
                {navItems.map((item, idx) => (
                  <motion.a
                    ...
                    onClick={() => setIsMobileOpen(false)}
                    className={`block px-4 py-3 text-[15px] font-medium rounded-lg transition-colors duration-200 ${
                      isDark
              ...
              <div className={`p-4 pt-2 border-t ${isDark ? "border-white/10" : "border-slate-200"}`}>
                <motion.a
                  ...
                  onClick={() => setIsMobileOpen(false)}
                  className={`block px-4 py-3 text-[15px] font-medium rounded-lg transition-colors duration-200 mb-2 ${
                    isDark
