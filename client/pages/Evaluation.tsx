...
export default function EvaluationPage() {
  ...
  const downloadPDF = () => {
    ...
    for (let i = 1; i <= pageCount; i++) {
      ...
      doc.text(
        `Generated by MedhaHub  |  Page ${i} of ${pageCount}`,
        pageW / 2,
        pageH - 8,
        { align: "center" }
      );
        ...
        <div className="max-w-5xl mx-auto space-y-8 sm:space-y-12 animate-fade-in">
          ...
          <Card className="p-6 sm:p-8 border-border/40 space-y-5">
            ...
            <div className="bg-gradient-to-br from-primary/5 to-secondary/5 border border-primary/10 rounded-xl p-5 space-y-3">
              <p className="font-semibold text-sm text-foreground">🎯 AI Mock Interview Results — MedhaHub</p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              ...
              <button
                onClick={() => {
                  const text = `🎯 Just completed my AI Mock Interview on MedhaHub!\n\n📊 Overall: ${scores.overall.toFixed(1)}/10\n✅ Communication: ${scores.communication.toFixed(1)}/10\n💻 Technical: ${scores.technical.toFixed(1)}/10\n💪 Confidence: ${scores.confidence.toFixed(1)}/10\n\nPractice your interview skills → https://medhahub.in\n#InterviewPrep #CareerGrowth #MedhaHub`;
                  window.open(`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://medhahub.in")}&summary=${encodeURIComponent(text)}`, "_blank");
                }}
              ...
              <button
                onClick={() => {
                  const text = `🎯 AI Mock Interview Results — MedhaHub\n\nOverall: ${scores.overall.toFixed(1)}/10\nCommunication: ${scores.communication.toFixed(1)}/10\nTechnical: ${scores.technical.toFixed(1)}/10\nConfidence: ${scores.confidence.toFixed(1)}/10\n\nTry it free: https://medhahub.in`;
